...
public class TankView extends JPanel implements Observer {
	...
	private void doDrawing(Graphics g) {
		...
		if (tankModel.getShowGlobalSnapshotDialog()) {
			tankModel.setShowGlobalSnapshotDialog(false);
			JOptionPane.showMessageDialog(getParent(),"Number fishies: " + tankModel.getGlobalSnapShot());
		}
